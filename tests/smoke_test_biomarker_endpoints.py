...
def test_biomarker_config_and_path_helpers() -> None:
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        output_split_root = output_preselection_root / "split_2"
        (output_split_root / "NP").mkdir(parents=True)
        ...
        assert os.path.samefile(resolved_preselection_root, output_split_root)
